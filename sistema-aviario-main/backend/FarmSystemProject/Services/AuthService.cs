...
public class AuthService : IAuthService
{
    ...
    public AuthService(AppDbContext context, ITokenService tokenService, IEmailService emailService, IOptions<FrontendOptions> frontendOptions)
    {
        _context = context;
    ...
    public async Task ForgotPassword(ForgotPasswordRequest request)
    {
        ...
        var frontendUrl = _frontend.BaseUrl.TrimEnd('/');
